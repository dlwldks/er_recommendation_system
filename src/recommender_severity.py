...
from src.scoring_severity import score_hospitals_by_severity_adaptive
from src.explanation import generate_explanation


def recommend_er_severity_adaptive(
    ...
    ranked = score_hospitals_by_severity_adaptive(
...
def recommend_for_all_patients_severity_adaptive(
    ...
    for _, patient_row in patients_df.iterrows():
        rec_df = recommend_er_severity_adaptive(
