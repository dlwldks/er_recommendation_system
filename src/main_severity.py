...
from src.recommender_severity import recommend_for_all_patients_severity_adaptive
from src.visualization import plot_recommendation_scatter


def main() -> None:
    paths = Paths()
    model_name = "severity_adaptive"
    ...
    results_df = recommend_for_all_patients_severity_adaptive(
    ...
    print("\n=== Severity-Adaptive Recommendation Results (Summary) ===")
